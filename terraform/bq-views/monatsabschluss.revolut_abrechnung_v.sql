SELECT 
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202606`
...
SELECT 
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202605`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202604`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
...
SELECT 
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202512`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202511`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202510`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
  ...
  , status
  , comment
FROM `af-finanzen.monatsabschluss.revolut_abrechnung_202509`
WHERE month IS NOT NULL
UNION ALL
SELECT 
    CAST(tid AS INT64) AS tid
